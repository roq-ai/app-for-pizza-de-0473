...
import { getPromocodeById } from 'apiSdk/promocodes';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Promocode Detail View
          </Text>
          {hasAccess('promocode', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/promocodes/edit/${data?.id}`} passHref legacyBehavior>
              <Button
