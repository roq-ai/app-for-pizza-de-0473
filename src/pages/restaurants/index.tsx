...
function RestaurantListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<RestaurantInterface[]>(
    ...
    () =>
      getRestaurants({
        relations: ['user', 'dish.count', 'promocode.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('dish', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>dish</Th>}
                  {hasAccess('promocode', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>promocode</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
